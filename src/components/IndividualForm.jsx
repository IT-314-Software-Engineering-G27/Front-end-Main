      ...
      <form className="form">
        <table className="form">
          <tbody>
            ...
            <tr>
              <td style={{ paddingBottom: '10px' }}>
                <input minLength={12} type="tel" id="phone-number" placeholder="+xx xxx-xxx-xxxx" onChange={(e) => setIndividual({ ...individual, user: { ...individual.user, phone_number: e.target.value } })} value={individual.user.phone_number} />
              </td>
            </tr>
            <tr>
              <td style={{ paddingBottom: '10px' }}>
