...
import {
    Checklist as ChecklistRoundedIcon,
    ...
    >
      <List>
        {[
          ...
          { text: 'Events', icon: <EventRoundedIcon />, link: '/jobs' },
          { text: 'Job Profile Post', icon: <CloudUploadRoundedIcon />, link: '/organizations/JobRegistration' },
          { text: 'Job Profile List', icon: <ChecklistRoundedIcon/>, link: '/organizations/JobRegistration' },
