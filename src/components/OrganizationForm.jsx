        ...
        <form>
            <table className="form">
                <tbody>
                    ...
                    <tr>
                        <td style={{ paddingBottom: '10px' }}>
                            <input type="text" id="number" placeholder="+xx xxx-xxx-xxxx" onChange={(e) => setOrganization({ ...organization, user: { ...organization.user, phone_number: e.target.value } })} value={organization.user.phone_number} />
                        </td>
                    </tr>
                    <tr>
                        <td style={{ paddingBottom: '10px' }}>
